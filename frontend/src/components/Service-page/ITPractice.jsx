...
const ITPractice = () => {
  ...
  const cardCls =
    "w-full h-auto lg:h-[476px] flex flex-col border border-[#E2E8F0] dark:border-white/10 rounded-3xl p-6 lg:p-10 bg-gray-400/20 dark:bg-white/5 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-gray-300 dark:hover:border-white/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group";
  ...
  const renderInner = (card) => (
    <>
      ...
      <h3 className="text-[22px] lg:text-[24px] font-jetbrains font-bold text-gray-900 dark:text-white mb-3 lg:mb-4 leading-[1.3]">
        {card.title}
      </h3>
  ...
  return (
    <section id="it-practice" className="py-24 bg-white dark:bg-[#0B1120] overflow-hidden">
