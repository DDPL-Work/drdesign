      ...
      columns: [
        {
          ...
          links: [
            {
              label: "Custom Software & Website Development",
              path: "/what-we-do#it-practice",
              state: { scrollToCard: 0 },
            },
            {
              label: "iOS & Android Applications",
              path: "/what-we-do#it-practice",
              state: { scrollToCard: 1 },
            },
            {
              label: "Cloud Infrastructure, Data & Analytics",
              path: "/what-we-do#it-practice",
        ...
        },
        {
          ...
          links: [
            {
              label: "Mapping Applications & Portals",
              path: "/what-we-do#gis-practice",
              state: { scrollToCard: 0 },
            },
            {
              label: "Satellite Imagery & LULC",
              path: "/what-we-do#gis-practice",
              state: { scrollToCard: 1 },
            },
            {
              label: "Drone Mapping & Photogrammetry",
              path: "/what-we-do#gis-practice",
              state: { scrollToCard: 2 },
            },
            {
              label: "Databases, Assets & Consulting",
              path: "/what-we-do#gis-practice",
              state: { scrollToCard: 3 },
            },
          ],
    ...
    >
      ...
      >
        <div className="w-full flex items-center justify-between">
          ...
          <div
            className="hidden md:flex items-center gap-8 lg:gap-12 relative"
                  ...
                  {activeDropdown === item.label &&
                    megaMenuData[item.label] && (
                      ...
                      >
                        ...
                        <div
                          className={`${megaMenuData[item.label].columns.length > 2 ? "w-[25%]" : "w-[45%]"} relative group`}
                        >
